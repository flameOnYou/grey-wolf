...
export default class CandleStickFloatLayerView extends TechnicalIndicatorFloatLayerView {
  _drawPrompt (
    kLineData: any, technicalIndicatorData: any, realDataPos: number, realDataPosX: number,
    technicalIndicator: any, isDrawValueIndicator: any
  ) {
  ...
  _drawCandleStickStandardPromptText (floatLayerPromptCandleStick: { text: { marginLeft: any; marginRight: any; size: any; color: any; weight: string | undefined; family: string | undefined; marginTop: any }; labels: any }, candleStickPromptData: any) {
    ...
    labels.forEach((label: any, i: string | number) => {
  ...
  _drawCandleStickRectPromptText (
    x: number, floatLayerPromptCandleStick: { labels: any; text: { marginLeft: any; marginRight: any; marginTop: any; marginBottom: any; size: any; color: any; weight: string | undefined; family: string | undefined }; rect: any }, candleStickPromptData: any, technicalIndicatorPromptData: { labels: any; values: any; name?: string }
  ) {
    ...
    let maxLabelWidth = 0
    baseLabels.forEach((label: any, i: string | number) => {
    ...
    if (isCandleStick) {
      ...
      indicatorLabels.forEach((label: any, i: string | number) => {
    ...
    if (isCandleStick) {
      ...
      indicatorLabels.forEach((label: string, i: number) => {
   ...
   * @param r
   */
  _drawRoundRect (x: number, y: number, w: any, h: any, r: number) {
    this._ctx.beginPath()
   ...
   * @private
   */
  _getCandleStickPromptData (kLineData: any, candleStick: any, floatLayerPromptCandleStick: any) {
