...
export default class ChartPane {
    ...
    _chartContainer!:HTMLElement
    _chartData!:ChartData
    _xAxisPane!:XAxisPane
    _candleStickPane!:CandleStickPane
    // _chartEvent!:ChartEvent
    _separatorDragStartTechnicalIndicatorHeight = 0
    _technicalIndicatorPanes:Array<TechnicalIndicatorPane> = new Array<TechnicalIndicatorPane>()
    _technicalIndicatorBaseId = 0
    _separatorPanes:Array<SeparatorPane> = new Array<SeparatorPane>()
   ...
   * @private
   */
  _initChartContainer (container:HTMLElement) {
   ...
   * @private
   */
  _separatorStartDrag (paneIndex:number) {
   ...
   * @private
   */
  _separatorDrag (dragDistance:number, paneIndex:number) {
   ...
   * @param params
   */
  applyTechnicalIndicatorParams (technicalIndicatorType:string, params:any) {
   ...
   * @private
   */
  _applyDataList (dataList:any, more:any, extendFun:any) {
    if (isArray(dataList)) {
   ...
   * @param more
   */
  applyNewData (dataList:any, more:boolean) {
  ...
  applyMoreData (dataList:any, more:any) {
    this._applyDataList(dataList, more, null)
  }
   ...
   * @param type
   */
  setCandleStickChartType (type:string) {
   ...
   * @returns {string}
   */
  createTechnicalIndicator (technicalIndicatorType = MACD, height = DEFAULT_TECHNICAL_INDICATOR_PANE_HEIGHT, dragEnabled:boolean) {
   ...
   * @param tag
   */
  removeTechnicalIndicator (tag:string) {
    let panePos = -1
    for (let i = 0; i < this._technicalIndicatorPanes.length; i++) {
   ...
   * @param technicalIndicatorType
   */
  setTechnicalIndicatorType (tag:string, technicalIndicatorType:string) {
   ...
   */
  getConvertPictureUrl (includeFloatLayer:any, includeGraphicMark:any, type = 'jpeg', backgroundColor = '#333333') {
    ...
    for (let i = 0; i < this._separatorPanes.length; i++) {
      ...
      ctx.drawImage(
        technicalIndicatorPane.getImage(includeFloatLayer,0),
    ...
    ctx.drawImage(
      this._xAxisPane.getImage(includeFloatLayer,0),
