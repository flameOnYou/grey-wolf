...
import ChartData, { GraphicMarkType } from '../data/ChartData'
...
export default class GraphicMarkView extends View {
  constructor (container:HTMLElement, chartData:ChartData, _xAxis:XAxis, _yAxis:YAxis) {
   ...
   * @param graphicMark
   */
  _drawHorizontalStraightLine (graphicMark:any) {
   ...
   * @param graphicMark
   */
  _drawVerticalStraightLine (graphicMark:any) {
    // this._drawPointGraphicMark(
   ...
   * @param graphicMark
   */
  _drawStraightLine (graphicMark:any) {
    // this._drawPointGraphicMark(
   ...
   * @param graphicMark
   */
  _drawHorizontalRayLine (graphicMark:any) {
    // this._drawPointGraphicMark(
   ...
   * @param graphicMark
   */
  _drawVerticalRayLine (graphicMark:any) {
    // this._drawPointGraphicMark(
   ...
   * @param graphicMark
   */
  _drawSegmentLine (graphicMark:any) {
    // this._drawPointGraphicMark(
   ...
   */
  _drawPriceLine (graphicMark:any, pricePrecision:number) {
    // this._drawPointGraphicMark(
   ...
   * @param graphicMark
   */
  _drawPriceChannelLine (graphicMark:any) {
    // this._drawPointGraphicMark(
   ...
   * @param graphicMark
   */
  _drawParallelStraightLine (graphicMark:any) {
    // this._drawPointGraphicMark(
   ...
   * @param pricePrecision
   */
  _drawFibonacciLine (graphicMark:any, pricePrecision:number) {
    // this._drawPointGraphicMark(
   ...
   */
  _drawPointGraphicMark (markKey: any, graphicMark: any, checkPointOnLine: any, generatedLinePoints: any, isDrawPrice: any, pricePrecision: any, priceExtendsText: any) {
   ...
   */
  _drawGraphicMark (
    graphicMark: any, linePoints: any, circlePoints: any, drawStep: any, checkPointOnLine: any,
    isDrawPrice: any, pricePrecision: any, priceExtendsText = []
  ) {
   ...
   * @private
   */
  _getLineType (point1:Point, point2:Point) {
