...
import { CrossHair } from '../utils/shape'
...
export default class TechnicalIndicatorFloatLayerView extends View {
   ...
   */
  _drawPrompt (
    kLineData: Bar, technicalIndicatorData: any,
    realDataPos: number, realDataPosX: number, technicalIndicator: any,
    isDrawValueIndicator: any
  ) {
   ...
   * @private
   */
  _drawCrossHairHorizontalLine (crossHair: CrossHair) {
   ...
   * @private
   */
  _drawCrossHairVerticalLine (crossHair: CrossHair, realDataPosX: number) {
  ...
  _drawTechnicalIndicatorPrompt (
    technicalIndicatorData: { [key: string]: any }, realDataPos: any, realDataPosX: any,
   ...
   * @private
   */
  _drawTechnicalIndicatorPromptText (dataPos: number,
     technicalIndicator: { result: any[]; plots: any },
     data: { labels: any; values: any; name: any },
     colors: string | any[], offsetTop: number) {
   ...
   * @private
   */
  _drawTechnicalIndicatorPromptPoint (realDataPos: any, realDataPosX: number, technicalIndicator: { plots: any }, values: string | any[], colors: string | any[]) {
